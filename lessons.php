...
<?php if ( $copern == 1 ) { ?>
   <div class="bar-btn-form-tool">
    <img src="../obr/ikony/upbox_blue_icon.png" onclick="Export1FAK();" title="Export fakt˙r za <?php echo $kli_vume; ?>" class="btn-form-tool">
...
<FORM name='fnewico' method='post' action='#' style="display:block; height:25px;">
 ...
 <div class="newico-bar">
  ...
  <a href="#" onclick="NewIco();" title="Vytvoriù novÈ I»O" >+ I»O</a>
 </div>
</FORM>
...
if ( $copern == 5 OR $copern == 8 )
     {
?>
<a href="#" onclick="ZoznamFak();" title="Zoznam fakt˙r za vybranÈ I»O" class="faktury-btn">Fakt˙ry</a>
